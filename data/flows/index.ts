  ...
  steps: [
    ...
    },
    {
      ...
      checklistItems: [
        {
          id: "asegurar_zona",
          label: "Asegurar zona del accidente",
          type: "info",
          required: true,
          hint: "Pasos clave para protegerte y proteger a los demás.",
        },
        {
          id: "llamar_911",
          label: "Llamar al 911 si hay heridos",
          type: "info",
          required: true,
          hint: "Comunicación directa con emergencias.",
        },
        {
          id: "tomar_fotos",
          label: "Tomar fotos generales de lejos",
          type: "camera",
          required: true,
          hint: "Registra la escena sin modificar nada.",
        },
        {
          id: "no_mover_vehiculos",
          label: "No mover los vehículos",
          type: "info",
          required: true,
          hint: "Mantener los autos en su posición original para peritaje.",
        },
      ],
      nextStep: "resumen",
    },
    ...
    },
    {
      ...
      checklistItems: [
        ...
        },
        {
          ...
          type: "text",
          required: false,
          placeholder: "Ej: conductor@correo.com",
          hint: "Para poder enviarle la información del accidente de manera directa.",
        },
