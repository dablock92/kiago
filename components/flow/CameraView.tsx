...
import { X, Zap, ZapOff, RotateCcw, Camera as CameraIcon } from 'lucide-react-native';
...
export function CameraView({ onCapture, onClose }: Props) {
  ...
  if (!permission) {
    return <View style={styles.container}><Text>Cargando cámara...</Text></View>;
  }

  if (!permission.granted) {
    return (
      <View style={styles.container}>
        <Text style={styles.message}>Necesitamos acceso a la cámara para capturar los documentos.</Text>
